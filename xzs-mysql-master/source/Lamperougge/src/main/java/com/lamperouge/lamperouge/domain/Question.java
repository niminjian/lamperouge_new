...
import com.lamperouge.lamperouge.domain.enums.QuestionTypeEnum;
import com.lamperouge.lamperouge.utility.ExamUtil;
...
public class Question implements Serializable {
    ...
    public void setCorrectFromVM(String correct, List<String> correstArray){
        int qType = this.getQuestionType();
        if (qType == QuestionTypeEnum.MultipleChoice.getCode()) {
            String correctJoin = ExamUtil.contentToString(correstArray);
