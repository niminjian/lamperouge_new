...
const state = {
  user: {
      ...
      levelEnum: [{ key: 1, value: '一年级' }],
        // { key: 2, value: '二年级' }, { key: 3, value: '三年级' }, { key: 4, value: '四年级' }, { key: 5, value: '五年级' }, { key: 6, value: '六年级' },
  ...
  exam: {
    ...
    question: {
      typeEnum: [
        { key: 1, value: '单选题' }],
        // { key: 2, value: '多选题' }, { key: 3, value: '判断题' }, { key: 4, value: '填空题' }, { key: 5, value: '简答题' }],
      editUrlEnum: [
