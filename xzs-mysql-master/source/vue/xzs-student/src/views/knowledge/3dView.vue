<template>
  <div class="gContainer">
    ...
    <router-link to="/knowledge/2dView"
      ><el-button type="primary" style="margin-top:20px">2D 模式</el-button></router-link
    ></div>
    <!-- <threeGraph /> -->
    <threeGraph
      :data="data"
...
export default {
  ...
  data () {
    return {
      ...
      names: ['学科', '学科类型', '学院', '知识点'],
      labels: ['ClassName', 'Type', 'Region', 'Knowledge'],
